...
/**
 * Used only the lambertian illumination model to render the scene.
 * 
 * @author leberre
 *
 */
public class LambertColorFinder extends AbstractMultilightColorFinder {

    @Override
    protected MyColor computeColorForLight(Intersection intersection, Point pos, Light light) {
        return light.lambert(intersection.object, pos);
    }
}
